...
function App() {
  ...
  return (
    <div className="App">
      <h1>Lista de Tarefas - Desafio Blend</h1>
            ...
            return (
              ...
              <div className="todo-list-item" key={index}>
                <div>
                  <h3>{item.title}</h3>
                  <p>{item.description}</p>
                  <p><small>Completa em: {item.completedOn}</small></p>
                </div>

                <div>
                  <RiDeleteBin6Line className='icon' onClick={() => handleDeleteCompletedTodo(index)} title="Deletar?" />
                </div>
              </div>
            )
          })}
